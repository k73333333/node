        ...
        $.ajax({
            ...
            success: function (data) {
                for (let index = 0; index < data.data.length; index++) {
                    if (data.data[index].name==self.yonghumin) {
                        console.log(index);
                    self.selectById.push({ name: data.data[index].name, phone: data.data[index].phone, imgsre: data.data[index].imgsre, spname: data.data[index].spname, spxq: data.data[index].spxq, shuliang: data.data[index].shuliang })
                    }
                }
            },
        })
