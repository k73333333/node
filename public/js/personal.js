...
new Vue({
    el: "#root",
    data: {
        touXiang: './img/touxiang.png',
        sheZhi: "./img/setting.png",
        name: "你是猪吗",
        topArr: [
            { shuLiang: 56, fenLeiName: "收藏夹" },
            { shuLiang: 16, fenLeiName: "关注店铺" },
            { shuLiang: 516, fenLeiName: "足迹" },
            { shuLiang: 6, fenLeiName: "红包卡卷" },],
        tab: ["发布的", "待收货", "已下架", "待评论"],
        content: [1, 2, 3, 4],
        Arrs: [
            {
